...
import { builderInfo, EXPOSES_MAP, parsedOptions } from '../globals'
import { basename, join, resolve } from 'path'
import { readdirSync, readFileSync, statSync } from 'fs'
import federation_fn_import from './import_remote.js?raw'
import { ConfigTypeSet, MfePlugin, MfePluginOptions } from '../../types'
