...
import { ViteDevServer as  OriginalDevServer } from 'vite'
...
import { builderInfo, parsedOptions } from '../globals'
...
type ViteDevServer = OriginalDevServer & {
  // what does this add?
...
const __mfes_remotesMap = remotesMap
export {
